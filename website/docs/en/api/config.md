...
| `pages.document`                                       | `string`                             | `<pages.dir>/_document.html`                                 | Follows the pages directory by default; explicit values still resolve from `root`                              |
| `pages.errorDir`                                       | `string`                             | `<pages.dir>/error`                                          | Follows the pages directory by default; explicit values still resolve from `root`                              |
...
| `indexHtml`                                            | `string`                             | Resolved `pages.document`                                    | HTML template; explicit values resolve from the project root                                                   |
...
| `alias`                                                | `object`                             | Built-in `@frontend/@pages/@components/@styles/@assets`      | Defaults follow role directories (`@styles` uses the CSS entry directory); explicit values resolve from `root` |
...
The registry is type-only and does not change runtime merge behavior. Register
only genuine whole-value capabilities; ordinary configuration objects should
remain recursively patchable.
