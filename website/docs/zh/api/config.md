...
| `styles.jscss.runtimeAdapter`                   | `'css-variables' \| 'none' \| false` | `'css-variables'`                                   | 动态样式变量的运行时输出方式                                        |
| `styles.jscss.dynamicVars`                      | `boolean`                            | `true`                                              | 是否生成动态 CSS variables                                          |
| `styles.jscss.recipes`                          | `boolean`                            | `true`                                              | 是否启用 recipe 样式组合输出                                        |
...
| `spaFallback.exclude`                           | `string[]`                           | `['/api/**', '/openapi.json', '/docs/**']`          | fallback 全局排除路径                                               |
...
| `render.timeoutMs`                              | `number`                             | `3000`                                              | 单次 SSR 超时时间                                                   |
