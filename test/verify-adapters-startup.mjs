...
function setupTempProject(adapterName, port) {
  ...
  writeFileSync(
    join(tmpDir, "src", "services", "probe.js"),
    `export default class ProbeService {
    constructor(app) { this.client = app.fetch.create({ baseURL: "http://localhost" }); }
  }`,
  );
