...
- `monsqlize@3.2.0`, controlled advanced constructor options, and complete raw-instance/model/collection capability access while preserving the stable `app.db` facade.
